...
export default function AdvertisingDataPage() {
  const router = useRouter();
  const { data: session } = useSession();
  const activeSection = "advertising-data";
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex gap-8">
            ...
            <main className="flex-1">
              <Card>
                <CardHeader>
                  <CardTitle>Dados de publicidade</CardTitle>
                  <CardDescription>
                    Configure como seus dados são usados para publicidade
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="py-8 text-center text-gray-500">
                    ...
                    <p className="text-sm mt-2">
                      As configurações de dados de publicidade serão
